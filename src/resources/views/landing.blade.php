...
@section('content')
    <div class="row p-2 pt-4" {!! \App\Http\Helpers\ColourPalletHelper::getHeaderStyle() !!}}>
        ...
        <div class="col-2 container-fluid">
            <a href="{{ route('settings.get') }}" class="text-white">
                <svg style="margin-top: 0.5em" xmlns="http://www.w3.org/2000/svg" {{ \App\Http\Helpers\IconSizeHelper::getHeightWidthAttributes(16) }} fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
    ...
    <div class="p-3">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <a type="button" class="btn btn-lg btn-dark container-fluid" href="{{ route('course.get', ['name' => 'Help']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" {{ \App\Http\Helpers\IconSizeHelper::getHeightWidthAttributes(16) }} fill="currentColor" class="bi bi-question-circle-fill" viewBox="0 0 16 16">
