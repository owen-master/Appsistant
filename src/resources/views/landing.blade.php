    ...
    <div class="p-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col pb-2">
                    <a type="button" class="btn btn-lg btn-outline-primary container-fluid" href="{{ route('course.get', ['name' => 'Camera']) }}">
                ...
                <div class="col pb-2">
                    <a type="button" class="btn btn-lg btn-outline-primary container-fluid" href="{{ route('course.get', ['name' => 'Calendar']) }}">
                ...
                <div class="col pb-2">
                    <a type="button" class="btn btn-lg btn-outline-primary container-fluid" href="{{ route('course.get', ['name' => 'Clock']) }}">
                ...
                <div class="col pb-2">
                    <a type="button" class="btn btn-lg btn-outline-primary container-fluid" href="{{ route('course.get', ['name' => 'Contacts']) }}">
                ...
                <div class="col pb-2">
                    <a type="button" class="btn btn-lg btn-outline-primary container-fluid" href="{{ route('course.get', ['name' => 'Email']) }}">
                ...
                <div class="col pb-2">
                    <a type="button" class="btn btn-lg btn-outline-primary container-fluid" href="{{ route('course.get', ['name' => 'Messages']) }}">
            ...
            <div class="row">
                <div class="col">
                    <a type="button" class="btn btn-lg btn-outline-danger container-fluid" href="{{ route('course.get', ['name' => 'Help']) }}">
