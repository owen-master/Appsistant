...
@section('content')
    <div class="p-3 pt-4" {!! \App\Http\Helpers\ColourPalletHelper::getHeaderStyle() !!}}>
        <div class="container">
            <div class="row my-2">
                <div class="col-4">
                    <button type="button" class="btn btn-dark" style="margin-left: 50%; transform: translateX(-50%)" onclick="location.href='{{route('splash.get')}}';">
                ...
                <div class="col-4">
                    ...
                    <small class="d-block text-center mb-2"><small>Calender</small></small>
                </div>
                <div class="col-4">
                    <button type="button" class="btn btn-dark" style="margin-left: 50%; transform: translateX(-50%)">
    ...
    <div style="background: #2d374880; width: 100%; height: auto; margin-top: -75px">
        <div class="container">
            <div class="row py-2">
                <div class="col-4">
                    <button type="button" class="btn btn-dark" style="margin-left: 50%; transform: translateX(-50%)">
